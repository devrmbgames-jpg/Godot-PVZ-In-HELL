...
- [ ] 2?5: Generic impact, pair dedup, valid throw bonus and source veto (separate commits).
- [ ] 6?9: Package profiles, protection, liquid tilt, intentional opening (separate commits).
