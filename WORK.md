...
- [ ] **5.1 IMMEDIATE GATE:** preserve `O_Damage`, refactor `S_Impact` to atomic GECS boundaries; remove System→System calls and `ECS.world.systems` service locator before any M6 work.
