...
- Physical props use E_Grabbable; its integration callback delegates force/torque to S_Grab. A C_HeldBy relationship is the authority for ownership; O_GrabLifecycle maintains collision exceptions and carry modifiers.
