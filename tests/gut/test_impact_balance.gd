...
func test_fragile_hit_cap_scales_with_effective_max_health() -> void:
	assert_almost_eq(ImpactCalculation.cap_damage(100.0, 100.0, FRAGILE), 25.0, 0.001)
	assert_almost_eq(ImpactCalculation.cap_damage(100.0, 40.0, FRAGILE), 10.0, 0.001)
