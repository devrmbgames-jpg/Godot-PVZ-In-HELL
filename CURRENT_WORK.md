...
- Next after correction: add shared capture tokens/lowered anchors and replace InteractionActions input routing with state-aware E/F, mapped hands, G and Terminal capture.
